...
public  abstract class HibernateDAO  extends ORMDAO{
    ...
    public static void instantiate(ServletContext ctx) {
    	if (sessionFactory == null) {
    		...
    		configuration.addClass(SalesLead.class).addResource("com/rainbow/crm/expensevoucher/model/ExpenseVoucher.hbm.xml");
    		configuration.addClass(SalesLeadLine.class).addResource("com/rainbow/crm/expensevoucher/model/ExpenseVoucherLine.hbm.xml");
